...
import * as $writing_islands_SolutionWriter from "./routes/writing/(_islands)/SolutionWriter.tsx";
...
const manifest = {
  ...
  islands: {
    ...
    "./routes/writing/(_islands)/SolutionWriter.tsx":
      $writing_islands_SolutionWriter,
  },
